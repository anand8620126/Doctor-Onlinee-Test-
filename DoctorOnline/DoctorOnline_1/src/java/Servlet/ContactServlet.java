...
public class ContactServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String Subject=request.getParameter("subtxt");
            String Message=request.getParameter("msgtxt");
            String Button=request.getParameter("sbtn");
            DoctorModel Model=new DoctorModel();
            try
            {
            if(Button.equals("Send Message"))
                if(Model.InsertContact(Name,Email,Subject,Message)==true)
                {
            ...
            {
            System.out.println("error in contact servlet"+ex);
            }
