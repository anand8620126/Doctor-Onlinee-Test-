    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String New_Password=request.getParameter("npwdtxt");
             String Admin_Name=request.getParameter("adminnametxt");
            ...
            {
            if(Model.ChangePasswordAdmin(Admin_Name,Password,New_Password)==true)
            {
                    RequestDispatcher rd=request.getRequestDispatcher("Admin_Login.jsp");
                    rd.forward(request, response);
            }
            ...
            {
            if(Model.CheckAdmin(Admin_Name,Password)==true)
            {
             ...
             {
             System.out.println("error in Admin servlet"+ex);
             }
