...
public final class Doctor_005fUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            {\n");
      out.write("                 var drnametxt=document.forms[\"drdetails\"][\"drnametxt\"].value;\n");
      out.write("               var x=document.forms[\"drdetails\"][\"pwdtxt\"].value;\n");
      out.write("                var addtxt=document.forms[\"drdetails\"][\"addtxt\"].value;\n");
      out.write("                var citytxt=document.forms[\"drdetails\"][\"citytxt\"].value;\n");
      out.write("                var phtxt=document.forms[\"drdetails\"][\"phtxt\"].value;\n");
      out.write("                var qlftxt=document.forms[\"drdetails\"][\"qlftxt\"].value;\n");
      out.write("                var exptxt=document.forms[\"drdetails\"][\"exptxt\"].value;\n");
      out.write("                var spctxt=document.forms[\"drdetails\"][\"spctxt\"].value;\n");
      out.write("                var prevhosntxt=document.forms[\"drdetails\"][\"prevhosntxt\"].value;\n");
      ...
      out.write("            <form name=\"drdetails\" onsubmit=\"return validateForm()\" action=\"DoctorServlet\">\n");
      out.write("                        <div class=\"row g-3\">\n");
      out.write("                            <div class=\"col-12\">\n");
      out.write("                                <input type=\"text\" name=\"drnametxt\" value=\"");
      out.print(aobj.get(1).toString());
      out.write("\"class=\"form-control border-0 bg-light px-4\" placeholder=\"Doctor Name\" style=\"height: 55px;\">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"col-12\">\n");
      out.write("                                <input type=\"text\" value=\"");
      out.print(aobj.get(3).toString());
      out.write("\" name=\"addtxt\"class=\"form-control border-0 bg-light px-4\" placeholder=\"Address\" style=\"height: 55px;\">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"col-12\">\n");
      out.write("                                <input type=\"text\" value=\"");
      out.print(aobj.get(4).toString());
      out.write("\" name=\"citytxt\"class=\"form-control border-0 bg-light px-4\" placeholder=\"City\" style=\"height: 55px;\">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"col-12\">\n");
      out.write("                                <input type=\"text\" value=\"");
      out.print(aobj.get(5).toString());
      out.write("\" name=\"phtxt\"class=\"form-control border-0 bg-light px-4\" placeholder=\"Phone\" style=\"height: 55px;\">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"col-12\">\n");
      out.write("                                <input type=\"text\" value=\"");
      out.print(aobj.get(6).toString());
      out.write("\" name=\"qlftxt\"class=\"form-control border-0 bg-light px-4\" placeholder=\"Qualification\" style=\"height: 55px;\">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"col-12\">\n");
      out.write("                                <input type=\"text\" value=\"");
      out.print(aobj.get(7).toString());
      out.write("\" name=\"exptxt\"class=\"form-control border-0 bg-light px-4\" placeholder=\"Experience\" style=\"height: 55px;\">\n");
      out.write("                            </div>\n");
      out.write("                            <div class=\"col-12\">\n");
      out.write("                                <input type=\"text\" name=\"spctxt\" value=\"");
      out.print(aobj.get(8).toString());
      out.write("\"class=\"form-control border-0 bg-light px-4\" placeholder=\"Specialization\" style=\"height: 55px;\">\n");
      out.write("                            </div>\n");
      out.write("                            \n");
      out.write("                            <div class=\"col-12\">\n");
      out.write("                              <input type=\"text\"value=\"");
      out.print(aobj.get(11).toString());
      out.write("\" name=\"regdate\"class=\"form-control border-0 bg-light px-4\" placeholder=\"Registration date\" style=\"height: 55px;\">\n");
      out.write("                            </div>\n");
      out.write("                            \n");
      out.write("                              <select name=\"hospitalid\" class=\"form-select bg-light border-0 mb-3\" style=\"height: 40px;\">\n");
      out.write("                                ");
 String a_hospid=aobj.get(9).toString();
                                sd.Connect();
                                try
                                {
